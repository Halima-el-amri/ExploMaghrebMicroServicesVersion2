package com.fileRouge.payment.util;

import java.util.ArrayList;
import java.util.List;
import com.fileRouge.payment.exception.InsufficientBalanceException;
import com.fileRouge.payment.exception.InvalidCardDetailException;
...
public class PaymentGatewaySimulator {
  ...
  static {
    accounts.add(
        new CardDetail("5161 4800 0276 4486", "09/30", "175", "MASTERCARD", "NMB", 75000.00));
    accounts.add(
        new CardDetail("4107 7342 3815 8180", "11/30", "186", "VISA", "CRDB", 55000.00));
  }
